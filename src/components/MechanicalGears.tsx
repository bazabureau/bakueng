...
export function MechanicalGears({ className = "" }: MechanicalGearsProps) {
  return (
    <div className={`absolute pointer-events-none opacity-10 ${className}`}>
      {/* Large Gear */}
      <svg
        className="absolute -right-20 -top-20 w-64 h-64 text-orange-500 animate-gear-slow"
        viewBox="0 0 100 100"
        fill="currentColor"
      >
      ...
      {/* Medium Gear */}
      <svg
        className="absolute -left-10 top-1/3 w-40 h-40 text-orange-600 animate-gear-medium"
        viewBox="0 0 100 100"
        fill="currentColor"
      >
      ...
      {/* Small Gear */}
      <svg
        className="absolute right-1/4 bottom-1/4 w-24 h-24 text-orange-500 animate-gear-fast"
        viewBox="0 0 100 100"
        fill="currentColor"
      >
